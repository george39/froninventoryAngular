...
@Component({
  selector: 'app-entradas-guarnecida-externa',
  templateUrl: './entradas-guarnecida-externa.component.html',
  styles: []
})
export class EntradasGuarnecidaExternaComponent implements OnInit {
